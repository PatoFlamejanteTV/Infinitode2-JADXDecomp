...
/* loaded from: infinitode-2.jar:com/codedisaster/steamworks/SteamController.class */
public class SteamController extends SteamInterface {
    ...
    private final long[] controllerHandles;
    private final int[] actionOrigins;

    /* loaded from: infinitode-2.jar:com/codedisaster/steamworks/SteamController$LEDFlag.class */
    public enum LEDFlag {
        SetColor,
        RestoreUserDefault
    }

    /* loaded from: infinitode-2.jar:com/codedisaster/steamworks/SteamController$Pad.class */
    public enum Pad {
        Left,
        Right
    }

    /* loaded from: infinitode-2.jar:com/codedisaster/steamworks/SteamController$Source.class */
    public enum Source {
        None,
        LeftTrackpad,
        RightTrackpad,
    ...
    /* loaded from: infinitode-2.jar:com/codedisaster/steamworks/SteamController$XboxOrigin.class */
    ...
    /* loaded from: infinitode-2.jar:com/codedisaster/steamworks/SteamController$SourceMode.class */
    ...
    /* loaded from: infinitode-2.jar:com/codedisaster/steamworks/SteamController$ActionOrigin.class */
    ...
    /* loaded from: infinitode-2.jar:com/codedisaster/steamworks/SteamController$InputType.class */
    public enum InputType {
        ...
        static InputType byOrdinal(int i) {
            return values[i];
        }
    }
    ...
    public int getConnectedControllers(SteamControllerHandle[] steamControllerHandleArr) {
        ...
        int connectedControllers = SteamControllerNative.getConnectedControllers(this.controllerHandles);
    ...
    public boolean showBindingPanel(SteamControllerHandle steamControllerHandle) {
        return SteamControllerNative.showBindingPanel(steamControllerHandle.handle);
    }

    public SteamControllerActionSetHandle getActionSetHandle(String str) {
        return new SteamControllerActionSetHandle(SteamControllerNative.getActionSetHandle(str));
    }
    ...
    public void activateActionSet(SteamControllerHandle steamControllerHandle, SteamControllerActionSetHandle steamControllerActionSetHandle) {
        SteamControllerNative.activateActionSet(steamControllerHandle.handle, steamControllerActionSetHandle.handle);
    }

    public SteamControllerActionSetHandle getCurrentActionSet(SteamControllerHandle steamControllerHandle) {
        return new SteamControllerActionSetHandle(SteamControllerNative.getCurrentActionSet(steamControllerHandle.handle));
    }

    public SteamControllerDigitalActionHandle getDigitalActionHandle(String str) {
        return new SteamControllerDigitalActionHandle(SteamControllerNative.getDigitalActionHandle(str));
    }
    ...
    public void getDigitalActionData(SteamControllerHandle steamControllerHandle, SteamControllerDigitalActionHandle steamControllerDigitalActionHandle, SteamControllerDigitalActionData steamControllerDigitalActionData) {
        SteamControllerNative.getDigitalActionData(steamControllerHandle.handle, steamControllerDigitalActionHandle.handle, steamControllerDigitalActionData);
    }
    ...
    public int getDigitalActionOrigins(SteamControllerHandle steamControllerHandle, SteamControllerActionSetHandle steamControllerActionSetHandle, SteamControllerDigitalActionHandle steamControllerDigitalActionHandle, ActionOrigin[] actionOriginArr) {
        ...
        int digitalActionOrigins = SteamControllerNative.getDigitalActionOrigins(steamControllerHandle.handle, steamControllerActionSetHandle.handle, steamControllerDigitalActionHandle.handle, this.actionOrigins);
    ...
    public SteamControllerAnalogActionHandle getAnalogActionHandle(String str) {
        return new SteamControllerAnalogActionHandle(SteamControllerNative.getAnalogActionHandle(str));
    }
    ...
    public void getAnalogActionData(SteamControllerHandle steamControllerHandle, SteamControllerAnalogActionHandle steamControllerAnalogActionHandle, SteamControllerAnalogActionData steamControllerAnalogActionData) {
        SteamControllerNative.getAnalogActionData(steamControllerHandle.handle, steamControllerAnalogActionHandle.handle, steamControllerAnalogActionData);
    }
    ...
    public int getAnalogActionOrigins(SteamControllerHandle steamControllerHandle, SteamControllerActionSetHandle steamControllerActionSetHandle, SteamControllerAnalogActionHandle steamControllerAnalogActionHandle, ActionOrigin[] actionOriginArr) {
        ...
        int analogActionOrigins = SteamControllerNative.getAnalogActionOrigins(steamControllerHandle.handle, steamControllerActionSetHandle.handle, steamControllerAnalogActionHandle.handle, this.actionOrigins);
    ...
    public void stopAnalogActionMomentum(SteamControllerHandle steamControllerHandle, SteamControllerAnalogActionHandle steamControllerAnalogActionHandle) {
        SteamControllerNative.stopAnalogActionMomentum(steamControllerHandle.handle, steamControllerAnalogActionHandle.handle);
    }

    public void triggerHapticPulse(SteamControllerHandle steamControllerHandle, Pad pad, int i) {
        SteamControllerNative.triggerHapticPulse(steamControllerHandle.handle, pad.ordinal(), i);
    }

    public void triggerRepeatedHapticPulse(SteamControllerHandle steamControllerHandle, Pad pad, int i, int i2, int i3, int i4) {
        SteamControllerNative.triggerRepeatedHapticPulse(steamControllerHandle.handle, pad.ordinal(), i, i2, i3, i4);
    }

    public void triggerVibration(SteamControllerHandle steamControllerHandle, short s, short s2) {
        SteamControllerNative.triggerVibration(steamControllerHandle.handle, s, s2);
    }

    public void setLEDColor(SteamControllerHandle steamControllerHandle, int i, int i2, int i3, LEDFlag lEDFlag) {
        SteamControllerNative.setLEDColor(steamControllerHandle.handle, (byte) i, (byte) i2, (byte) i3, lEDFlag.ordinal());
    }

    public int getGamepadIndexForController(SteamControllerHandle steamControllerHandle) {
        return SteamControllerNative.getGamepadIndexForController(steamControllerHandle.handle);
    }

    public SteamControllerHandle getControllerForGamepadIndex(int i) {
        return new SteamControllerHandle(SteamControllerNative.getControllerForGamepadIndex(i));
    }
    ...
    public void getMotionData(SteamControllerHandle steamControllerHandle, SteamControllerMotionData steamControllerMotionData) {
        SteamControllerNative.getMotionData(steamControllerHandle.handle, steamControllerMotionData.data);
    }

    public String getStringForActionOrigin(ActionOrigin actionOrigin) {
        return SteamControllerNative.getStringForActionOrigin(actionOrigin.ordinal());
    }

    public String getGlyphForActionOrigin(ActionOrigin actionOrigin) {
        return SteamControllerNative.getGlyphForActionOrigin(actionOrigin.ordinal());
    }

    public InputType getInputTypeForHandle(SteamControllerHandle steamControllerHandle) {
        return InputType.byOrdinal(SteamControllerNative.getInputTypeForHandle(steamControllerHandle.handle));
    }
}
