...
/* loaded from: infinitode-2.jar:com/codedisaster/steamworks/SteamMatchmakingCallbackAdapter.class */
class SteamMatchmakingCallbackAdapter extends SteamCallbackAdapter<SteamMatchmakingCallback> {
    ...
    void onLobbyEnter(long j, int i, boolean z, int i2) {
        ((SteamMatchmakingCallback) this.callback).onLobbyEnter(new SteamID(j), i, z, SteamMatchmaking.ChatRoomEnterResponse.byValue(i2));
    }
    ...
    void onLobbyChatMessage(long j, long j2, int i, int i2) {
        ((SteamMatchmakingCallback) this.callback).onLobbyChatMessage(new SteamID(j), new SteamID(j2), SteamMatchmaking.ChatEntryType.byValue(i), i2);
    }
