...
/* loaded from: infinitode-2.jar:com/codedisaster/steamworks/SteamUGCCallbackAdapter.class */
class SteamUGCCallbackAdapter extends SteamCallbackAdapter<SteamUGCCallback> {
    ...
    void onSubmitItemUpdate(long j, boolean z, int i) {
        ((SteamUGCCallback) this.callback).onSubmitItemUpdate(new SteamPublishedFileID(j), z, SteamResult.byValue(i));
    }
    ...
    void onDeleteItem(long j, int i) {
        ((SteamUGCCallback) this.callback).onDeleteItem(new SteamPublishedFileID(j), SteamResult.byValue(i));
    }
}
