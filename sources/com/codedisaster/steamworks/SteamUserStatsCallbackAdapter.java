...
/* loaded from: infinitode-2.jar:com/codedisaster/steamworks/SteamUserStatsCallbackAdapter.class */
class SteamUserStatsCallbackAdapter extends SteamCallbackAdapter<SteamUserStatsCallback> {
    ...
    void onNumberOfCurrentPlayersReceived(boolean z, int i) {
        ((SteamUserStatsCallback) this.callback).onNumberOfCurrentPlayersReceived(z, i);
    }
