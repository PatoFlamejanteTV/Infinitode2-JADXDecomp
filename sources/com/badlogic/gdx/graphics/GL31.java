...
/* loaded from: infinitode-2.jar:com/badlogic/gdx/graphics/GL31.class */
public interface GL31 extends GL30 {
    ...
    int glGetProgramResourceIndex(int i, int i2, String str);

    String glGetProgramResourceName(int i, int i2, int i3);

    void glGetProgramResourceiv(int i, int i2, int i3, IntBuffer intBuffer, IntBuffer intBuffer2, IntBuffer intBuffer3);

    int glGetProgramResourceLocation(int i, int i2, String str);

    void glUseProgramStages(int i, int i2, int i3);

    void glActiveShaderProgram(int i, int i2);

    int glCreateShaderProgramv(int i, String[] strArr);
    ...
    void glProgramUniform1iv(int i, int i2, IntBuffer intBuffer);

    void glProgramUniform2iv(int i, int i2, IntBuffer intBuffer);

    void glProgramUniform3iv(int i, int i2, IntBuffer intBuffer);

    void glProgramUniform4iv(int i, int i2, IntBuffer intBuffer);

    void glProgramUniform1uiv(int i, int i2, IntBuffer intBuffer);

    void glProgramUniform2uiv(int i, int i2, IntBuffer intBuffer);

    void glProgramUniform3uiv(int i, int i2, IntBuffer intBuffer);

    void glProgramUniform4uiv(int i, int i2, IntBuffer intBuffer);

    void glProgramUniform1fv(int i, int i2, FloatBuffer floatBuffer);

    void glProgramUniform2fv(int i, int i2, FloatBuffer floatBuffer);

    void glProgramUniform3fv(int i, int i2, FloatBuffer floatBuffer);

    void glProgramUniform4fv(int i, int i2, FloatBuffer floatBuffer);

    void glProgramUniformMatrix2fv(int i, int i2, boolean z, FloatBuffer floatBuffer);

    void glProgramUniformMatrix3fv(int i, int i2, boolean z, FloatBuffer floatBuffer);

    void glProgramUniformMatrix4fv(int i, int i2, boolean z, FloatBuffer floatBuffer);

    void glProgramUniformMatrix2x3fv(int i, int i2, boolean z, FloatBuffer floatBuffer);

    void glProgramUniformMatrix3x2fv(int i, int i2, boolean z, FloatBuffer floatBuffer);

    void glProgramUniformMatrix2x4fv(int i, int i2, boolean z, FloatBuffer floatBuffer);

    void glProgramUniformMatrix4x2fv(int i, int i2, boolean z, FloatBuffer floatBuffer);

    void glProgramUniformMatrix3x4fv(int i, int i2, boolean z, FloatBuffer floatBuffer);

    void glProgramUniformMatrix4x3fv(int i, int i2, boolean z, FloatBuffer floatBuffer);

    void glValidateProgramPipeline(int i);

    String glGetProgramPipelineInfoLog(int i);

    void glBindImageTexture(int i, int i2, int i3, boolean z, int i4, int i5, int i6);

    void glGetBooleani_v(int i, int i2, IntBuffer intBuffer);
