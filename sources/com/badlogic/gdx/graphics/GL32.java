...
/* loaded from: infinitode-2.jar:com/badlogic/gdx/graphics/GL32.class */
public interface GL32 extends GL31 {
    ...
    /* loaded from: infinitode-2.jar:com/badlogic/gdx/graphics/GL32$DebugProc.class */
    ...
    void glDebugMessageControl(int i, int i2, int i3, IntBuffer intBuffer, boolean z);

    void glDebugMessageInsert(int i, int i2, int i3, int i4, String str);

    void glDebugMessageCallback(DebugProc debugProc);

    int glGetDebugMessageLog(int i, IntBuffer intBuffer, IntBuffer intBuffer2, IntBuffer intBuffer3, IntBuffer intBuffer4, IntBuffer intBuffer5, ByteBuffer byteBuffer);

    void glPushDebugGroup(int i, int i2, String str);

    void glPopDebugGroup();

    void glObjectLabel(int i, int i2, String str);

    String glGetObjectLabel(int i, int i2);

    long glGetPointerv(int i);
    ...
    void glDrawElementsInstancedBaseVertex(int i, int i2, int i3, int i4, int i5, int i6);
    ...
    void glGetnUniformfv(int i, int i2, FloatBuffer floatBuffer);

    void glGetnUniformiv(int i, int i2, IntBuffer intBuffer);

    void glGetnUniformuiv(int i, int i2, IntBuffer intBuffer);
    ...
    void glTexBufferRange(int i, int i2, int i3, int i4, int i5);
