...
/* loaded from: infinitode-2.jar:com/badlogic/gdx/backends/headless/HeadlessPreferences.class */
public class HeadlessPreferences implements Preferences {
    private final Properties properties;
    private final FileHandle file;

    public HeadlessPreferences(String str, String str2) {
        this(new HeadlessFileHandle(new File(str2, str), Files.FileType.External));
    }

    public HeadlessPreferences(FileHandle fileHandle) {
