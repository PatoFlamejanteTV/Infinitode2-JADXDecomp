...
@REGS
/* loaded from: infinitode-2.jar:com/prineside/tdi2/actions/SelectTowerAbilityAction.class */
public class SelectTowerAbilityAction extends Action {
    ...
    public String toString() {
        return "SelectTowerAbility " + this.x + SequenceUtils.SPACE + this.y + SequenceUtils.SPACE + this.abilityIndex;
    }
}
