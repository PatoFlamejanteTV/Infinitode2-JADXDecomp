...
@REGS
/* loaded from: infinitode-2.jar:com/prineside/tdi2/actions/SellTowerAction.class */
public class SellTowerAction extends Action {
    public int x;
    public int y;

    private SellTowerAction() {
    }
    ...
    public String toString() {
        return "SellTower " + this.x + SequenceUtils.SPACE + this.y;
    }
}
