...
@REGS
/* loaded from: infinitode-2.jar:com/prineside/tdi2/actions/SellModifierAction.class */
public class SellModifierAction extends Action {
    public int x;
    public int y;

    private SellModifierAction() {
    }
    ...
    public String toString() {
        return "SellModifier " + this.x + SequenceUtils.SPACE + this.y;
    }
}
