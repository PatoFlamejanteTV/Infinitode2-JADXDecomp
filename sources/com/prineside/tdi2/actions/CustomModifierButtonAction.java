...
@REGS
/* loaded from: infinitode-2.jar:com/prineside/tdi2/actions/CustomModifierButtonAction.class */
public class CustomModifierButtonAction extends Action {
    ...
    public String toString() {
        return "CustomModifierButton " + this.x + SequenceUtils.SPACE + this.y + SequenceUtils.SPACE + this.mapX + SequenceUtils.SPACE + this.mapY;
    }
}
