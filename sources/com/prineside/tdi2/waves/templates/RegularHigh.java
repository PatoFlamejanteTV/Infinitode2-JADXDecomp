...
/* loaded from: infinitode-2.jar:com/prineside/tdi2/waves/templates/RegularHigh.class */
public class RegularHigh extends WaveTemplates.WaveTemplate {

    /* renamed from: a, reason: collision with root package name */
    private final WaveTemplates.EnemyGroupConfig[] f4011a = {new WaveTemplates.EnemyGroupConfig(this) { // from class: com.prineside.tdi2.waves.templates.RegularHigh.1
        ...
        public int getCount(int i, float f, float f2) {
            return 16 + ((int) StrictMath.pow(i, 0.66d));
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public float getHealth(int i, float f, float f2) {
            return 11.0f + (((float) StrictMath.pow(f2 * 10.0d, 1.26d)) * 0.06f);
        }
