...
/* loaded from: infinitode-2.jar:com/prineside/tdi2/waves/templates/LightMedium.class */
public class LightMedium extends WaveTemplates.WaveTemplate {

    /* renamed from: a, reason: collision with root package name */
    private final WaveTemplates.EnemyGroupConfig[] f4010a = {new WaveTemplates.EnemyGroupConfig(this) { // from class: com.prineside.tdi2.waves.templates.LightMedium.1
        ...
        public int getCount(int i, float f, float f2) {
            return (int) ((12 + ((int) StrictMath.pow(i, 0.65d))) * a(i));
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public float getHealth(int i, float f, float f2) {
            return 12.0f + (((float) StrictMath.pow(f2 * 10.5d, 1.27d)) * 0.055f);
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public float getBounty(int i, float f, float f2) {
            return (2.0f + (i * 0.05f)) * b(i);
        }
