...
/* loaded from: infinitode-2.jar:com/prineside/tdi2/waves/templates/HealerJet.class */
public class HealerJet extends WaveTemplates.WaveTemplate {

    /* renamed from: a, reason: collision with root package name */
    private final WaveTemplates.EnemyGroupConfig[] f4000a = {new WaveTemplates.EnemyGroupConfig(this) { // from class: com.prineside.tdi2.waves.templates.HealerJet.1
        private static float a(int i) {
            return MathUtils.clamp(0.5f + ((i / 10.0f) * 0.5f), 0.0f, 1.0f);
        }
        ...
        public int getCount(int i, float f, float f2) {
            return (int) ((5 + ((int) StrictMath.pow(i, 0.58d))) * 0.5f * a(i));
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public float getHealth(int i, float f, float f2) {
            return 5.0f + (((float) StrictMath.pow(f2 * 10.0d, 1.29d)) * 0.02f);
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public float getBounty(int i, float f, float f2) {
            return (4.5f + (i * 0.12f)) * b(i);
        }
        ...
        public float getKillExp(int i, float f, float f2) {
            return (2.5f + (i * 0.025f)) * b(i);
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public int getKillScore(int i, float f, float f2) {
            return (int) (30.0f * b(i));
        }
    }, new WaveTemplates.EnemyGroupConfig(this) { // from class: com.prineside.tdi2.waves.templates.HealerJet.2
        private static float a(int i) {
        ...
        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public float getHealth(int i, float f, float f2) {
            return 12.5f + (((float) StrictMath.pow(f2 * 10.0d, 1.24d)) * 0.062f);
        }
