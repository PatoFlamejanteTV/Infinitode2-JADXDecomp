...
/* loaded from: infinitode-2.jar:com/prineside/tdi2/waves/templates/JetMedium.class */
public class JetMedium extends WaveTemplates.WaveTemplate {

    /* renamed from: a, reason: collision with root package name */
    private final WaveTemplates.EnemyGroupConfig[] f4007a = {new WaveTemplates.EnemyGroupConfig(this) { // from class: com.prineside.tdi2.waves.templates.JetMedium.1
        ...
        public int getCount(int i, float f, float f2) {
            return (int) ((6 + ((int) StrictMath.pow(i, 0.58d))) * 0.6f * a(i));
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public float getHealth(int i, float f, float f2) {
            return 5.5f + (((float) StrictMath.pow(f2 * 10.0d, 1.28d)) * 0.03f);
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public float getBounty(int i, float f, float f2) {
            return (5.25f + (i * 0.15f)) * b(i);
        }
