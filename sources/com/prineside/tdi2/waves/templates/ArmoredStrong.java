...
/* loaded from: infinitode-2.jar:com/prineside/tdi2/waves/templates/ArmoredStrong.class */
public class ArmoredStrong extends WaveTemplates.WaveTemplate {

    /* renamed from: a, reason: collision with root package name */
    private final WaveTemplates.EnemyGroupConfig[] f3991a = {new WaveTemplates.EnemyGroupConfig(this) { // from class: com.prineside.tdi2.waves.templates.ArmoredStrong.1
    ...
    }, new WaveTemplates.EnemyGroupConfig(this) { // from class: com.prineside.tdi2.waves.templates.ArmoredStrong.2
        private static float a(int i) {
            return MathUtils.clamp(0.4f + ((i / 20.0f) * 0.6f), 0.0f, 1.0f);
        }
