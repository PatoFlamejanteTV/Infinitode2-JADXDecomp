...
/* loaded from: infinitode-2.jar:com/prineside/tdi2/waves/templates/FastMedium.class */
public class FastMedium extends WaveTemplates.WaveTemplate {

    /* renamed from: a, reason: collision with root package name */
    private final WaveTemplates.EnemyGroupConfig[] f3994a = {new WaveTemplates.EnemyGroupConfig(this) { // from class: com.prineside.tdi2.waves.templates.FastMedium.1
        ...
        public int getCount(int i, float f, float f2) {
            return (int) ((11.4f + ((int) StrictMath.pow(i, 0.63d))) * a(i));
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public float getHealth(int i, float f, float f2) {
            return 9.9f + (((float) StrictMath.pow(f2 * 10.0d, 1.28d)) * 0.045f);
        }
