...
/* loaded from: infinitode-2.jar:com/prineside/tdi2/waves/templates/HealerRegular.class */
public class HealerRegular extends WaveTemplates.WaveTemplate {

    /* renamed from: a, reason: collision with root package name */
    private final WaveTemplates.EnemyGroupConfig[] f4001a = {new WaveTemplates.EnemyGroupConfig(this) { // from class: com.prineside.tdi2.waves.templates.HealerRegular.1
    ...
    }, new WaveTemplates.EnemyGroupConfig(this) { // from class: com.prineside.tdi2.waves.templates.HealerRegular.2
        private static float a(int i) {
            return MathUtils.clamp(0.6f + ((i / 25.0f) * 0.4f), 0.0f, 1.0f);
        }
