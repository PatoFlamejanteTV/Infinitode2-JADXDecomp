...
/* loaded from: infinitode-2.jar:com/prineside/tdi2/waves/templates/HealerIcy.class */
public class HealerIcy extends WaveTemplates.WaveTemplate {

    /* renamed from: a, reason: collision with root package name */
    private final WaveTemplates.EnemyGroupConfig[] f3999a = {new WaveTemplates.EnemyGroupConfig(this) { // from class: com.prineside.tdi2.waves.templates.HealerIcy.1
        ...
        public float getHealth(int i, float f, float f2) {
            return 9.0f + (((float) StrictMath.pow(f2 * 10.0d, 1.29d)) * 0.05f);
        }
    ...
    }, new WaveTemplates.EnemyGroupConfig(this) { // from class: com.prineside.tdi2.waves.templates.HealerIcy.2
        private static float a(int i) {
            return MathUtils.clamp(0.6f + ((i / 25.0f) * 0.4f), 0.0f, 1.0f);
        }
