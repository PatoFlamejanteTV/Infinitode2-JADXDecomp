...
/* loaded from: infinitode-2.jar:com/prineside/tdi2/waves/templates/StrongMedium.class */
public class StrongMedium extends WaveTemplates.WaveTemplate {

    /* renamed from: a, reason: collision with root package name */
    private final WaveTemplates.EnemyGroupConfig[] f4015a = {new WaveTemplates.EnemyGroupConfig(this) { // from class: com.prineside.tdi2.waves.templates.StrongMedium.1
        ...
        public int getCount(int i, float f, float f2) {
            return (int) ((8 + ((int) StrictMath.pow(i, 0.565d))) * 0.85f * a(i));
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public float getHealth(int i, float f, float f2) {
            return 17.0f + (((float) StrictMath.pow(f2 * 10.0d, 1.27d)) * 0.08f);
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public float getBounty(int i, float f, float f2) {
            return (2.7f + (i * 0.072f)) * b(i);
        }
