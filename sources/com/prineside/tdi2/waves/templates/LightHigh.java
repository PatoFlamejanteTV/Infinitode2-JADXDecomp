...
/* loaded from: infinitode-2.jar:com/prineside/tdi2/waves/templates/LightHigh.class */
public class LightHigh extends WaveTemplates.WaveTemplate {

    /* renamed from: a, reason: collision with root package name */
    private final WaveTemplates.EnemyGroupConfig[] f4009a = {new WaveTemplates.EnemyGroupConfig(this) { // from class: com.prineside.tdi2.waves.templates.LightHigh.1
        ...
        public int getCount(int i, float f, float f2) {
            return (int) ((16 + ((int) StrictMath.pow(i, 0.7d))) * a(i));
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public float getHealth(int i, float f, float f2) {
            return 7.5f + (((float) StrictMath.pow(f2 * 10.0d, 1.27d)) * 0.0375f);
        }
