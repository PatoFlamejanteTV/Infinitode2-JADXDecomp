...
import com.prineside.tdi2.systems.randomEncounter.type.runningStar.RunningStarEncounterHandler;
import com.prineside.tdi2.utils.REGS;

@REGS
/* loaded from: infinitode-2.jar:com/prineside/tdi2/systems/randomEncounter/type/RunningStarEncounter.class */
public class RunningStarEncounter implements KryoSerializable, RandomEncounterSystem.BirdAction, RandomEncounterSystem.EncounterType {
    ...
    public void performAction(GameSystemProvider gameSystemProvider, EncounterBird encounterBird) {
        new RunningStarEncounterHandler(gameSystemProvider);
    }
}
