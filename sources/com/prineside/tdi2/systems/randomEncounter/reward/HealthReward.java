...
@REGS
/* loaded from: infinitode-2.jar:com/prineside/tdi2/systems/randomEncounter/reward/HealthReward.class */
public class HealthReward implements KryoSerializable, RandomEncounterSystem.RewardType {
    ...
    private HealthReward() {
    }

    public HealthReward(int i, int i2) {
    ...
    public void giveReward(GameSystemProvider gameSystemProvider, float f, float f2) {
        ...
        gameSystemProvider.gameState.addHealth(this.count);
    }
}
