...
/* loaded from: infinitode-2.jar:com/prineside/tdi2/scene2d/actions/RemoveListenerAction.class */
public class RemoveListenerAction extends Action {
    ...
    public boolean act(float f) {
        if (this.d) {
            this.f2637b.removeCaptureListener(this.c);
            return true;
        }
        this.f2637b.removeListener(this.c);
        return true;
    }
