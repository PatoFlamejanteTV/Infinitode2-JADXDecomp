...
/* loaded from: infinitode-2.jar:com/vladsch/flexmark/ext/gitlab/GitLabInline.class */
public class GitLabInline extends Node implements DelimitedNode {
    ...
    public GitLabInline(BasedSequence basedSequence) {
        super(basedSequence);
        this.openingMarker = BasedSequence.NULL;
        this.text = BasedSequence.NULL;
        this.closingMarker = BasedSequence.NULL;
    ...
    public GitLabInline(BasedSequence basedSequence, BasedSequence basedSequence2, BasedSequence basedSequence3) {
