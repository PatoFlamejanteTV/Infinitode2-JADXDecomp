...
/* loaded from: infinitode-2.jar:com/vladsch/flexmark/ext/gitlab/GitLabInlineMath.class */
public class GitLabInlineMath extends Node implements DelimitedNode {
    ...
    public GitLabInlineMath(BasedSequence basedSequence) {
        super(basedSequence);
        this.openingMarker = BasedSequence.NULL;
        this.text = BasedSequence.NULL;
        this.closingMarker = BasedSequence.NULL;
    ...
    public GitLabInlineMath(BasedSequence basedSequence, BasedSequence basedSequence2, BasedSequence basedSequence3) {
