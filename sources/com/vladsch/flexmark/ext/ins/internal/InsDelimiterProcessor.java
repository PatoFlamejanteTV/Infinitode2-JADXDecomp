...
/* loaded from: infinitode-2.jar:com/vladsch/flexmark/ext/ins/internal/InsDelimiterProcessor.class */
public class InsDelimiterProcessor implements DelimiterProcessor {
    ...
    public void process(Delimiter delimiter, Delimiter delimiter2, int i) {
        delimiter.moveNodesBetweenDelimitersTo(new Ins(delimiter.getTailChars(i), BasedSequence.NULL, delimiter2.getLeadChars(i)), delimiter2);
    }
}
