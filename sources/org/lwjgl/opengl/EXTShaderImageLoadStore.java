...
/* loaded from: infinitode-2.jar:org/lwjgl/opengl/EXTShaderImageLoadStore.class */
public class EXTShaderImageLoadStore {
    ...
    public static native void glBindImageTextureEXT(@NativeType("GLuint") int i, @NativeType("GLuint") int i2, @NativeType("GLint") int i3, @NativeType("GLboolean") boolean z, @NativeType("GLint") int i4, @NativeType("GLenum") int i5, @NativeType("GLint") int i6);

    public static native void glMemoryBarrierEXT(@NativeType("GLbitfield") int i);
