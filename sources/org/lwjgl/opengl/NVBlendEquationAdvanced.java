...
/* loaded from: infinitode-2.jar:org/lwjgl/opengl/NVBlendEquationAdvanced.class */
public class NVBlendEquationAdvanced {
    ...
    public static native void glBlendParameteriNV(@NativeType("GLenum") int i, @NativeType("GLint") int i2);
