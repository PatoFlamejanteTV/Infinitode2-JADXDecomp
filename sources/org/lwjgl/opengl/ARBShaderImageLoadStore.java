...
/* loaded from: infinitode-2.jar:org/lwjgl/opengl/ARBShaderImageLoadStore.class */
public class ARBShaderImageLoadStore {
    ...
    public static void glBindImageTexture(@NativeType("GLuint") int i, @NativeType("GLuint") int i2, @NativeType("GLint") int i3, @NativeType("GLboolean") boolean z, @NativeType("GLint") int i4, @NativeType("GLenum") int i5, @NativeType("GLenum") int i6) {
        GL42C.glBindImageTexture(i, i2, i3, z, i4, i5, i6);
    }

    public static void glMemoryBarrier(@NativeType("GLbitfield") int i) {
