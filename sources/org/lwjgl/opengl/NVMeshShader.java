...
/* loaded from: infinitode-2.jar:org/lwjgl/opengl/NVMeshShader.class */
public class NVMeshShader {
    ...
    public static native void glDrawMeshTasksNV(@NativeType("GLuint") int i, @NativeType("GLuint") int i2);

    public static native void glDrawMeshTasksIndirectNV(@NativeType("GLintptr") long j);

    public static native void glMultiDrawMeshTasksIndirectNV(@NativeType("GLintptr") long j, @NativeType("GLsizei") int i, @NativeType("GLsizei") int i2);

    public static native void glMultiDrawMeshTasksIndirectCountNV(@NativeType("GLintptr") long j, @NativeType("GLintptr") long j2, @NativeType("GLsizei") int i, @NativeType("GLsizei") int i2);
