...
/* loaded from: infinitode-2.jar:org/lwjgl/glfw/GLFWErrorCallbackI.class */
public interface GLFWErrorCallbackI extends CallbackI {
    ...
    void invoke(int i, @NativeType("char *") long j);
    ...
    default void callback(long j, long j2) {
        invoke(MemoryUtil.memGetInt(MemoryUtil.memGetAddress(j2)), MemoryUtil.memGetAddress(MemoryUtil.memGetAddress(j2 + POINTER_SIZE)));
    }
}
