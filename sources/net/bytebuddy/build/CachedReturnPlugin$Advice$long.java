...
/* loaded from: infinitode-2.jar:net/bytebuddy/build/CachedReturnPlugin$Advice$long.class */
class CachedReturnPlugin$Advice$long {
    ...
    protected static long enter(@CachedReturnPlugin.CacheField long j) {
        return j;
    }

    @Advice.OnMethodExit
    @SuppressFBWarnings(value = {"UC_USELESS_VOID_METHOD", "DLS_DEAD_LOCAL_STORE"}, justification = "Advice method serves as a template")
    protected static void exit(@Advice.Return(readOnly = false) long j, @CachedReturnPlugin.CacheField long j2) {
    }
}
